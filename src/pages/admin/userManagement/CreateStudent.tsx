...
// import { createStudentSchema } from "../../../schemas/academicManagement.schema";
...
const CreateStudent = () => {
  ...
  const { data: sData, isLoading: sIsloading } = useGetAllSemestersQuery([
    ...
    <Row>
      <Col span={24}>
        <PHForm onSubmit={onSubmit}>
          ...
          <Button htmlType="submit" disabled={addStudentLoading}>
            Submit
          </Button>
        </PHForm>
      </Col>
